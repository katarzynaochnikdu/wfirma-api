...
def orders_list():
    ...
    <div class="orders-table-wrapper">
      <table class="orders-table">
        ...
        <tbody>
          {''.join(rows) if rows else '<tr><td colspan="8" class="orders-empty"><img src="/Empty_list_1.png" alt="Brak zamówień" style="max-width:420px; width:100%; height:auto; opacity:0.9;" /></td></tr>'}
        </tbody>
      </table>
    </div>

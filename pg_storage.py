    ...
    try:
        ...
        cur.execute(
            ...
            SELECT o.event_order_id, o.event_id, o.purchaser_email, o.purchaser_first_name, o.purchaser_last_name,
                   ...
                   (SELECT COALESCE(p.data->>'company', p.data->>'company_name', p.data->>'firma', '') 
                    FROM participants p WHERE p.event_order_id = o.event_order_id LIMIT 1) as purchaser_company,
